...
export function EventsIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
...
export function FeedIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function PocketIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M21 12a2.25 2.25 0 00-2.25-2.25H15a3 3 0 110-6h.008A2.25 2.25 0 0121 6V4.5A2.25 2.25 0 0018.75 2.25H5.25A2.25 2.25 0 003 4.5v15A2.25 2.25 0 005.25 21.75h13.5A2.25 2.25 0 0021 19.5V12z" />
      <path d="M17.25 12a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
    </svg>
  );
}

export function HubIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function TicketIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function TrashIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.255H8.084a2.25 2.25 0 01-2.244-2.255L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" />
    </svg>
  );
}
...
export function VenuesIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2.25 21h19.5M3.75 21V6.75A2.25 2.25 0 016 4.5h6a2.25 2.25 0 012.25 2.25V21M3.75 21h10.5M14.25 21V12.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V21M14.25 21H20.25M7.5 9.75h.008v.008H7.5V9.75zm0 3h.008v.008H7.5v-.008zm0 3h.008v.008H7.5v-.008zm3-6h.008v.008H10.5V9.75zm0 3h.008v.008H10.5v-.008zm0 3h.008v.008H10.5v-.008z" />
    </svg>
  );
}
...
export function ShieldCheckIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M9 12.75l3 3 6-6M2.25 12a14.004 14.004 0 0011.25 13.75v-13.75h-11.25zM12 2.25V21.75c3.75 0 7.5-1.5 10.5-4.5V11.25c0-4.5-4.5-9-10.5-9z" />
    </svg>
  );
}
...
export function RepostIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M19.5 12c0-1.232-.47-2.352-1.243-3.193L15 6M4.5 12c0 1.232.47 2.352 1.243 3.193L9 18" />
      <path d="M15 6H7.5A3.5 3.5 0 0 0 4 9.5v.5M9 18h7.5a3.5 3.5 0 0 0 3.5-3.5v-.5" />
    </svg>
  );
}
...
export function AggregatorIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
...
export function LayoutListIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
