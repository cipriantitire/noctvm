    ...
    <form onSubmit={handleSubmit} className="space-y-6 p-6 bg-noctvm-black border border-white/10 rounded-3xl frosted-noise shadow-2xl relative overflow-hidden group">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 relative z-10">
        <div className="space-y-1.5">
          ...
          <input
            required
            className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 focus:border-noctvm-violet/50 outline-none transition-all font-bold tracking-tight text-foreground placeholder:text-foreground/10 frosted-noise text-sm"
            placeholder="Name..."
            value={formData.name}
        ...
        <div className="space-y-1.5 relative">
          ...
          <div className="relative group/upload">
            <input
              ...
              className="w-full bg-white/5 border border-white/10 rounded-xl pl-4 pr-[35%] py-2.5 focus:border-noctvm-violet/50 outline-none transition-all font-mono text-noctvm-micro text-foreground/60 uppercase tracking-widest placeholder:text-foreground/10 frosted-noise"
              placeholder="https://..."
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 relative z-10">
        <div className="space-y-1.5">
          ...
          <div className="relative">
            <select
              className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 focus:border-noctvm-violet/50 outline-none transition-all font-bold tracking-tight text-foreground appearance-none frosted-noise cursor-pointer uppercase text-sm"
              value={formData.city}
        ...
        <div className="space-y-1.5">
          ...
          <input
            type="number"
            className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 focus:border-noctvm-violet/50 outline-none transition-all font-mono font-bold text-sm text-foreground frosted-noise"
      ...
      <div className="space-y-1.5 relative z-10">
        ...
        <textarea
          rows={1}
          className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 focus:border-noctvm-violet/50 outline-none transition-all resize-none font-mono text-noctvm-micro text-foreground/60 uppercase tracking-widest placeholder:text-foreground/10 frosted-noise"
          placeholder="https://..."
      ...
      <div className="space-y-1.5 relative z-10">
        ...
        <textarea
          rows={3}
          className="w-full bg-white/5 border border-white/10 rounded-2xl px-4 py-3 focus:border-noctvm-violet/50 outline-none transition-all resize-none font-medium text-xs text-foreground/80 placeholder:text-foreground/10 frosted-noise leading-relaxed"
      ...
      <div className="flex justify-end gap-3 pt-4 border-t border-white/5 relative z-10">
        <button
          type="button"
          onClick={onCancel}
          className="px-5 py-2 text-noctvm-silver hover:text-foreground transition-all font-bold text-noctvm-micro uppercase tracking-widest"
        >
          Cancel
        </button>
        <button
          type="submit"
          disabled={loading}
          className="px-8 py-2.5 bg-noctvm-violet text-foreground rounded-xl font-bold text-noctvm-caption uppercase tracking-widest hover:bg-noctvm-violet/80 transition-all disabled:opacity-50 flex items-center gap-2 active:scale-[0.96] shadow-lg shadow-noctvm-violet/20"
        >
