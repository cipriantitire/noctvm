  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: 'w-[27px] h-[27px] rounded-full text-xs font-medium text-noctvm-silver/70 hover:bg-white/5 hover:text-white transition-colors flex items-center justify-center cursor-pointer',
        day_selected: 'bg-noctvm-violet !text-white hover:bg-noctvm-violet !w-[27px] !h-[27px]',
