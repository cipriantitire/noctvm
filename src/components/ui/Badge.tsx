...
const variantClass: Record<NonNullable<BadgeProps["variant"]>, string> = {
  genre:
    "px-2.5 py-1 rounded-full corner-smooth-none text-noctvm-caption uppercase font-bold bg-white/5 text-noctvm-silver/70 border border-white/5 tracking-wide",
  featured:
