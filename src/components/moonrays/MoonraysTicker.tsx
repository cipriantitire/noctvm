  ...
  return (
    <section className="space-y-4">
      <div className="flex items-center justify-between px-2">
        <h2 className="text-sm font-heading font-bold text-foreground uppercase tracking-widest opacity-40">Live Feed</h2>
          ...
          {txns.map((txn) => (
            ...
            >
              ...
              <div className="flex items-center gap-4 relative z-10">
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center border border-white/5 bg-noctvm-black/40 shadow-inner`}>
                  {txn.txn_type === 'CREDIT' ? 
                ...
                <div>
                  <p className="text-xs font-semibold text-foreground/90">{txn.description}</p>
