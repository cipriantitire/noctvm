...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    if (didError || !renderer || !material || !geometry || !scene || !camera) {
      return;
    }
    ...
    renderer.domElement.style.opacity = '0.78';
    renderer.domElement.style.filter = 'brightness(0.72) saturate(1.2)';
  ...
  return (
    <div
      ...
      style={{
        ...
        overflow: 'hidden',
        background:
          'radial-gradient(120% 90% at 10% 10%, rgba(82, 39, 255, 0.12), transparent 55%), radial-gradient(100% 80% at 90% 20%, rgba(255, 159, 252, 0.1), transparent 60%), radial-gradient(80% 100% at 50% 100%, rgba(124, 255, 103, 0.08), transparent 65%), #050505',
        ...style
      }}
    />
  );
