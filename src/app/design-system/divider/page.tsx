...
export default function DividerPage() {
  return (
    <div className="space-y-10">
      <div>
        <h1 className="text-2xl font-bold text-white mb-2">Divider</h1>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4 max-w-md">
          <p className="text-sm text-white">Content above</p>
          <Divider />
          <p className="text-sm text-white">Content below</p>
        </div>
      </div>
      <div className="space-y-6">
