...
export default function CollapsiblePage() {
  return (
    <div className="space-y-12 animate-fade-in pb-24">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-foreground mb-2 font-heading uppercase tracking-wider">Collapsible</h1>
        ...
        <div className="bg-noctvm-surface/30 p-6 rounded-2xl border border-white/5 space-y-3">
          <Collapsible>
            <div className="flex items-center justify-between">
              <p className="text-sm font-medium text-foreground">Lineup &amp; Artists</p>
          ...
          <Collapsible>
            <div className="flex items-center justify-between border-t border-white/5 pt-3">
              <p className="text-sm font-medium text-foreground">Venue Rules</p>
              <CollapsibleTrigger asChild>
                <Button variant="ghost" size="sm">Toggle</Button>
              </CollapsibleTrigger>
            </div>
